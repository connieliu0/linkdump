...
var Ae = (e) => we[`${D.getInitializationId()}.${e}`];
var W = (e) => {
...
var F = () => window;
var et = (e) => "touches" in e ? e.touches.length > 1 : false;
...
var O = ({ position: e, zoom: t }) => t ? `translate(${e.x}px, ${e.y}px) scale(${t})` : `translate(${e.x}px, ${e.y}px)`;
var nt = () => {
  const e = () => {
    e.done = true;
  };
...
var B = (e, t) => (Object.entries(t).forEach(([n, o]) => {
...
var yn = (e) => e.clientHeight < e.scrollHeight;
var dt = (e) => "scrollX" in e && "scrollY" in e;
var Se = (e) => {
  if (dt(e)) {
    const n = e;
    return {
...
var zn = (e, t) => {
  ...
  return l + V > m ? p.left = true : m + V > a && (p.right = true), c + V > h ? p.top = true : h + V > f && (p.bottom = true), p;
};
var Rn = () => {
  const {
    childNode: e,
...
var he = (e) => typeof e == "string" ? parseInt(e, 10) : e;
var wn = (e, t) => {
  const n = {};
...
var Tn = ({ elementsRef: e }) => () => e.current;
var yt = ({
  id: e,
  elementsRef: t,
  position: n
...
var Yn = ({ childNode: e, positionRef: t, zoomRef: n }) => (o, r) => {
  const i = t;
...
var Hn = ({
  ...
  return ["top", "left", "right", "bottom"].reduce((i, s) => {
    const l = e === true ? void 0 : e[s], c = Zn(
      l === void 0 ? r[s] : l,
      o
    );
    return {
...
var Un = ({ childNode: e, positionRef: t, zoomRef: n }) => () => {
  const o = n, r = t;
...
var Rt = (0, import_react.createContext)({});
var vt = (e, t) => {
...
var bt = ({
  ...
  const r = (0, import_react.useRef)(), i = (0, import_react.useRef)(), s = (0, import_react.useRef)(null), [l, c] = (0, import_react.useState)(false), u = e.map((f) => o[f]);
  vt(() => {
  ...
  const d = (0, import_react.useMemo)(() => ({
    initialized: l,
    panZoomRef: s
  }), [l]), a = import_react.default.createElement(Rt.Provider, { value: d }, import_react.default.createElement("div", { ref: i }, import_react.default.createElement("div", { ref: r }, n)));
  return {
    childRef: r,
    parentRef: i,
    panZoomRef: s,
...
var io = ({
  ...
  return (0, import_react.useLayoutEffect)(() => (r.current = zt(o.current, {
    ...n,
    className: n.className || "react-panzoom"
  }), r.current.setOptions(n), s(true), r.current.destroy), []), i;
};
var so = (0, import_react.forwardRef)((e, t) => import_react.default.createElement(io, { ...e, apiRef: t }));
...
var ho = ({
  ...
  const v = (0, import_react.useRef)(), E = (0, import_react.useRef)(), { initialized: b, panZoomRef: M } = (0, import_react.useContext)(Rt), $ = {
  ...
  return (0, import_react.useLayoutEffect)(() => {
    ...
    w,
    N
  ]), import_react.default.createElement("div", { ref: v }, e);
};
var co = ["boundary"];
var lo = $e().filter((e) => !co.includes(e));
var uo = ({
  apiRef: e,
  children: t,
  cover: n,
...
var ao = (0, import_react.forwardRef)(
  (e, t) => import_react.default.createElement(uo, { ...e, apiRef: t })
);
