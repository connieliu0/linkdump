...
const ChangelogDialog = ({ isOpen, onClose }) => {
  return (
    ...
    >
        <ul>
          <li><p>New <a href="https://chromewebstore.google.com/detail/linkdump-saver/eemcbhaiifgompigbdjfhklaimdcdndh" target="_blank" rel="noopener noreferrer">chrome extension</a> for easier link saving</p></li>
